  ...
  return (
    ...
    >
      <div className="max-w-3xl"> {/* Ensure this div allows text to align under navbar based on main's padding */}
        <h1 className="font-headline text-3xl sm:text-4xl md:text-4xl font-bold text-foreground mb-1 sm:mb-2 animate-fadeInUp">
          i&apos;m rocky <span role="img" aria-label="victory hand">✌️</span>
        </h1>
        <p className="font-headline text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mb-1 sm:mb-2 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          product designer unfolding stories
        </p>
        <p className="font-headline text-2xl sm:text-3xl md:text-3xl font-bold text-foreground animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
