  ...
  return (
    ...
    >
      <div className="max-w-3xl"> {/* Adjusted max-width */}
        ...
        <p className="font-jakarta text-5xl sm:text-6xl md:text-8xl font-bold text-foreground mb-3 sm:mb-4 animate-fadeInUp" style={{ animationDelay: '0.2s' }}> {/* Adjusted text size */}
