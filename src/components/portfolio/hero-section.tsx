  ...
  return (
    ...
    >
      <div className="max-w-3xl"> {/* Removed pt-16 */}
        <h1 className="font-jakarta text-3xl sm:text-4xl md:text-4xl font-bold text-foreground mb-1 sm:mb-2 animate-fadeInUp">
        ...
        <p className="font-jakarta text-2xl sm:text-3xl md:text-3xl font-bold text-foreground animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
