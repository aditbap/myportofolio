...
const HeroSection: React.FC = () => {
  return (
    ...
    >
      <div className="px-6 pt-56"> {/* Increased pt-48 to pt-56 */}
        ...
        <p
          className="font-jakarta font-extrabold text-3xl sm:text-4xl md:text-5xl text-foreground mb-1 sm:mb-2 animate-fadeInUp"
