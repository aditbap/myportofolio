...
const SpotlightCard: React.FC<SpotlightCardProps> = ({
  ...
  const handleFocus = () => {
    setIsFocused(true);
    setOpacity(0.6); // Matched to onMouseEnter for consistency
  };
  ...
  const handleMouseEnter = () => {
    setOpacity(0.6); // Increased opacity for better visibility based on user request
  };
  ...
  return (
    <div
      ...
      // Removed p-8 from here, added overflow-hidden for better child control
